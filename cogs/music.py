...
# NOTE: These helper functions are intended to be in main.py or a shared utility file.
# If they are duplicated here, it's for completeness of this single file.
